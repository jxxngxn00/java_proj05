...
public class Using_Array {
	...
	public static void main(String[] args) {
		// 기본 자료형인 경우 : RAM에 Stack 영역에 변수와 값이 같이 저장됨.
		// 참조 자료형인 경우 : RAM에 Stack 영역에 변수명이 저장이 되고
		//					Heap 영역에 변수의 값이 저장됨.
		...
		// new : Heap 영역의 배열방 5개를 생성해서 Heap 영역의 번지를 a 변수에 할당해라 
		...
		System.out.println("배열 변수 a의 방의 갯수 : "+a.length);		//배열 방의 총 갯수를 출력
		...
		System.out.println(a);				//Heap메모리의 주소
		System.out.println("============");
