...
class Human {		//사람		: 부모 클래스 : 자식 클래스의 공통적인 필드와 메소드를 선언
	...
	//메소드 정의
	void eat() {		System.out.println("모든 사람은 먹는다.");
	}
	void sleep() {		System.out.println("모든 사람은 잠을 잔다.");
	}
	void print() {
...
class Student extends  Human {		//Student 클래스는 Human 클래스를 상속받음. 
...
class Professor extends Human{
	int professorID;
	void goToCollage() {
		System.out.println("교수님이 학교에 갑니다.");
	}
