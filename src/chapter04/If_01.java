	...
	public static void main(String[] args) {
		 ...
		 * - 반복 제어문 : for, while, do while
		 ...
		 if : 조건을 만족하는 실행문을 실행 후 if 문을 빠져나온다.
		 	(break을 사용하지 않더라도 if문을 빠져나온다.
		 	cf. switch문은 break를 사용해서 구문을 빠져나온다.)
		*	if (조건) {실행문};	//조건이 참일때 실행문 실행
		
		*	if (조건) {
				실행문1; }
			else { 실행문2; }
			
		*	if (조건1) { 실행문1; }			// 조건 1이 참일때, 실행문 1을 실행
			else if (조건2) { 실행문2; }	// 조건 2가 참일때, 실행문 2를 실행
			else if (조건3) { 실행문3; }	// 조건 3이 참일때, 실험문 3을 실행
			...
			else { 실행문10; }			// 위의 모든 조건을 만족하지 않을때 실행문 10을 실행
			*/
		
		//if (조건) { 실행문1 }
		
		System.out.println("===조건이 false===");
		if (3>5 ) { System.out.println("안녕"); System.out.println("방가"); }
		// 조건이 false이므로 실행문 내의 구문은 실행되지 않는다.
		...
		System.out.println("============");
		if (5 < 3) 
			System.out.println("오늘은 비가 옵니다.");		// 중괄호 생략 (if문에 해당)
			System.out.println("비가 보슬 보슬 옵니다.");		// 중괄호 밖의 실행구문
			
			/*
			 * 2. if (조건) { 실행문1 ; }			//조건이 참일때, 실행문1 실행
			 *  else { 실행문2 ; }				//조건이 거짓일때, 실행문2 실행
			 */
			System.out.println("============");
...
//		System.out.println(a);	변수의 값을 넣지 않고 출력
		 ...
		 * 	  : 해당 조건을 만족하는 실행문은 실행 후 if문 탈출
		 */
		System.out.println("============");
		int c = 85;
		if (c>=90) {
			System.out.println("A 학점입니다.");	//false
		}else if (c>=80) {
			System.out.println("B 학점입니다.");	//true
